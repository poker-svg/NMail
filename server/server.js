 ...
 * @LastEditTime: 2023-04-02 14:48:19
...
// 导入并注册邮件路由中间件
const sendEmailRouter = require("./router/email");
server.use("/my/email", sendEmailRouter);
...
server.listen(3007, function () {
  console.log("N-Mail Server listening at http://127.0.0.1:3007");
});
